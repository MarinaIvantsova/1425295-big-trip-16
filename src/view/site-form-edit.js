...
export const createSiteFormEditTemplate = (route, offers) => {
  ...
  offers.forEach((offer, index) => {
    const selected =  selectedOffers.find((offerSelected) => offerSelected.title === offer.title);
    offersString += ` <div class="event__offer-selector">
    <input class="event__offer-checkbox  visually-hidden" id="event-offer-comfort-${index}" type="checkbox" name="event-offer-comfort" ${selected? 'checked' : ''}>
